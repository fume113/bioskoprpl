        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration">
            <div class="card-body p-4 p-md-5">
              <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Drink Order</h3>
              <form>

                <div class="row">


                  <div class="form-outline-mnm">
                    <input type="text" id="jenisminuman" class="form-control form-control-lg" />
                    <label class="form-label" for="Jenisminuman">Nama Minuman</label>
                  </div>
